...
if __name__ == "__main__":
    ...
    # Load Data
    # ----------------------------
    # use repository-local dataset path
    ...
    # ----------------------------
    # SMAPE Loss + Optimizer with stronger weight decay
    # ----------------------------
    ...
    optimizer = optim.AdamW(model.parameters(), lr=3e-3, weight_decay=1e-3)  # Increased weight decay

    # ----------------------------
    # Training Loop (5 epochs + early stop)
    # ----------------------------
